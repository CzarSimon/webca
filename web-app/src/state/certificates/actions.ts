...
const REMOVE_SELECTED_SIGNATORY = '@webca/certificates/REMOVE_SELECTED_SIGNATORY';
...
export const removeSelectedSignatory = createAction(REMOVE_SELECTED_SIGNATORY)<void>();
